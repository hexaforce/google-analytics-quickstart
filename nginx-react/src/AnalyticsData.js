...
import { Button, Stack, Card, Form, ListGroup, OverlayTrigger, Tooltip, Container, Row, Col, Modal } from 'react-bootstrap';
...
const AnalyticsData = () => {
  ...
  return (
    <Card>
      <Card.Body>
        <Card.Title>AnalyticsData</Card.Title>
        <pre style={{ color: "red" }}>{JSON.stringify(error, undefined, 2)}</pre>
        <Form className='m-3' >
      ...
      <Button className='mx-5 px-5' variant="primary" onClick={runReport}>
        Run Report
      </Button>
